...
ActiveRecord::Schema[7.0].define(version: 2024_11_24_080120) do
  ...
  create_table "user_skills", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["skill_category_id"], name: "index_user_skills_on_skill_category_id"
  ...
  add_foreign_key "user_skills", "skill_categories"
